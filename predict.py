...
from builders.model_builder import build_model
from builders.dataset_builder import build_dataset_val
...
def test_model(args):
    ...
    # load the test set
    datas, testLoader = build_dataset_val(args.dataset, args.num_workers, none_gt=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str,
                        default="D:\ELANet-master\checkpoint\cityscapes\ELANetbs8gpu1_train\model_1500.pth",
                        help="use the file to load the checkpoint for evaluating or testing ")
    parser.add_argument('--save_seg_dir', type=str, default="./result/8train",
